...
<header id="topbar" class="ph10">
  ...
  <div class="topbar-left col-sm-3">
    <ul class="nav nav-list nav-list-topbar pull-left">
      <li><a href="admin/stockmanagement/stock?status=5" class="btn btn-link {{($status==5)?'btn-active':''}}" style="color: #1D6FC4;">行权所得</a></li>
      <li><a href="admin/stockmanagement/stock?status=6" class="btn btn-link {{($status==6)?'btn-active':''}}" style="color: #1D6FC4;">公司回购</a></li>
    </ul>
  </div>

  <div class="row col-sm-9">
    <form action="admin/stockmanagement/stock/search/{{$status}}">
      <div class="col-sm-10">
